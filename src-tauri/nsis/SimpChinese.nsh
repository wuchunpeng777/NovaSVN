...
LangString dontUninstall ${LANG_SIMPCHINESE} "直接升级（推荐，覆盖安装）"
...
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已存在版本为 $R4 的 ${PRODUCTNAME}。推荐直接覆盖升级（默认）。如需彻底清理，可选择先卸载再安装。选择操作后点击下一步继续。"
