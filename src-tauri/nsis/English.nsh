...
LangString dontUninstall ${LANG_ENGLISH} "Upgrade in place (recommended)"
...
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed on your system. Upgrading in place is recommended (default). Choose uninstall first only if you want a clean reinstall. Select an option and click Next to continue."
